...
pub fn write_efi_tables(
    ...
    // each entry a { u64 base; u64 size; } pair. The kernel appends to this in
    // place, so it gets its own page and is never handed back as usable memory.
